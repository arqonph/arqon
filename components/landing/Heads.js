  ...
  return (
    <div className="story">
      <div className="container pt-5">
        <div className="row">
          <div className="architect-card container col-xxl-4 col-lg-6 col-md-8 mb-5 aprilMD">
              ...
              <div className="descriptionOverlayHrzApril">
                <div className="infoHorizontal">
                  <span>
                    ...
                    <a className="linkedin" href="https://www.linkedin.com/in/april-pulido/" target="_blank">
                      LinkedIn:
                    </a>
                  </span>
                </div>
              </div>
              <div className="contentboxOverlayHidden">
          ...
          <div className="architect-card container col-xxl-4 col-lg-6 col-md-8 mb-5 mannyBIM">
            <div className="mannyImg position-relative">
              <div className="contentBox">
                <span className="">Arch. Manny Pulido</span>
              </div>
              <div className="descriptionOverlayHrzManny">
                <div className="infoHorizontal">
                  <span>
                    ...
                    <nbspan>
                      ...
                      Philippines’ most prominent architectural firms.
                    </nbspan>
                    <br className="pt-5"></br>
                    <a className="linkedin" href="https://www.linkedin.com/in/manuel-nestor-pulido/"target="_blank">
                      LinkedIn:
                    </a>
                  </span>
                </div>
          ...
          <div className="architect-card container col-xxl-4 col-lg-6 col-md-8 mb-5 chinoPM">
            <div className="chinoImg position-relative">
              <div className="contentBox">
                <span className="">Arch. Chino Buitizon</span>
              </div>
              <div className="descriptionOverlayHrzChino">
                <div className="infoHorizontal">
                  <span>
                    ...
                    <br className="pt-5"></br>
                    <a className="linkedin" href="https://www.linkedin.com/in/joseph-buitizon/" target="_blank">
                      LinkedIn:
                    </a>
                  </span>
                </div>
          ...
          <div className="container background-textcolor  mb-5 "></div>
        </div>
      </div>
      <br className="pb-30"></br>
      <br className="pb-30"></br>
      <br className="pb-30"></br>
      <br className="pb-30"></br>
    </div>
