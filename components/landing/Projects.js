    ...
    <div>
        ...
        <div className='pt-5'>
          ...
          <div className='row gx-0 residence pt-3 d-flex justify-content-center align-items-center'>
            ...
            <div className='col-lg-6 projectContainer'>
              <div className='position-relative gResidence' type='button' data-bs-toggle='modal' data-bs-target='#gResidenceModal'>
            ...
            {/* G_RESIDENCE MODAL AND CAROUSEL */}
            <div className='modal fade modal-xl' id='gResidenceModal' tabIndex='-1' aria-labelledby='gResidenceModelLabel' aria-hidden='true'>
              <div className='modal-dialog modal-dialog-centered '>
                <div className='modal-content modalProject'>
                  {/* <div className='modal-header'>
                    <h5 className='modal-title' id='sResidenceModelLabel'>N RESIDENCE</h5>
                  ...
                  <div className='modal-body m-4'>
                    <div className='gResidenceSlider'>
                      <div id='gResidenceCarouselControls' className='carousel slide' data-bs-ride='carousel'>
                        <div className='carousel-inner'>
                          <div className='carousel-item active'>
                            <Image src={gResidence01} alt='G_Residence01' />
                          </div>
                        </div>
                        <button className='carousel-control-prev' type='button' data-bs-target='#gResidenceCarouselControls' data-bs-slide='prev'>
                          <span className='carousel-control-prev-icon' aria-hidden='true'></span>
                          <span className='visually-hidden'>Previous</span>
                        </button>
                        <button className='carousel-control-next' type='button' data-bs-target='#gResidenceCarouselControls' data-bs-slide='next'>
                          <span className='carousel-control-next-icon' aria-hidden='true'></span>
                          <span className='visually-hidden'>Next</span>
                        </button>
                      </div>
            ...
            {/* T_RESIDENCE MODAL AND CAROUSEL */}
            <div className='modal fade modal-xl' id='tResidenceModal' tabIndex='-1' aria-labelledby='tResidenceModelLabel' aria-hidden='true'>
              <div className='modal-dialog modal-dialog-centered '>
                <div className='modal-content modalProject'>
                  {/* <div className='modal-header'>
                    <h5 className='modal-title' id='sResidenceModelLabel'>N RESIDENCE</h5>
                  ...
                  <div className='modal-body m-4'>
                    <div className='tResidenceCarousel'>
                      <div id='tResidenceCarouselControls' className='carousel slide' data-bs-ride='carousel'>
                        <div className='carousel-inner'>
                          <div className='carousel-item active'>
                            <Image src={tResidence01} alt='T_Residence01' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence02} alt='T_Residence02' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence03} alt='T_Residence03' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence04} alt='T_Residence04' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence05} alt='T_Residence05' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence06} alt='T_Residence06' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence07} alt='T_Residence07' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence08} alt='T_Residence08' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence09} alt='T_Residence09' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence10} alt='T_Residence10' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence11} alt='T_Residence11' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence12} alt='T_Residence12' />
                          </div>
                          <div className='carousel-item'>
                            <Image src={tResidence13} alt='T_Residence13' />
                          </div>
                        </div>
